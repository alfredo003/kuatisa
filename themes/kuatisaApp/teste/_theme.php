...
<div class="app">
    <header class="app_header">
        <h1><a class="transition" href="<?= url("/app"); ?>" title="Kuatisa">      
        <img style="width:245px;" src="<?= theme("/assets/images/logo.png", CONF_VIEW_APP); ?>"/></a></h1>
    ...
    <footer class="app_footer">
        <span class="">
            Kuatisa - Serviços e profissionais<br>
