                ...
                <div class="post_page_meta">
                    <div class="author">
                        <div><img alt="<?= "{$service->author()->first_name} {$service->author()->last_name}"; ?>"
                                  ...
                                  src="<?= image($service->author()->photo, 200); ?>"/></div>
                        <div class="name">
        ...
        <div class="post_page_content">
            ...
            <aside class="social_share">
                ...
                <div class="social_share_medias">
                    <!--facebook-->
                    <div class="fb-share-button" data-href="<?= url("/servico/{$service->uri}"); ?>" data-layout="button_count"
                         data-size="large"
                         data-mobile-iframe="true">
                        <a target="_blank"
                           href="https://www.facebook.com/sharer/sharer.php?u=<?= urlencode("/servico/{$service->uri}"); ?>"
                           class="fb-xfbml-parse-ignore">Compartilhar</a>
                    </div>

                    <!--twitter-->
                    <a href="https://twitter.com/share?ref_src=site" class="twitter-share-button" data-size="large"
                       data-text="<?= $service->title; ?>" data-url="<?= url("/servico/{$service->uri}"); ?>"
